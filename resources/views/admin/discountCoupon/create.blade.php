        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="max_uses">Max Use</label>
                            <input type="number" name="max_uses" id="max_uses" class="form-control" placeholder="Max Use">
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="max_uses_user">Max Use User</label>
                            <input type="text" name="max_uses_user" id="max_uses_user" class="form-control" placeholder="Max Use User">
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
